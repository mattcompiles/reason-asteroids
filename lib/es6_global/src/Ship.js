...
function update(ship, screenSize) {
  return handleDeadState(calcWeaponState(removeOldBullets(updateBullets(calcPosition(calcVelocity(calcThrust(calcAngle(ship, Controls.activeInput), Controls.activeInput), Controls.activeInput), screenSize)), screenSize), Controls.activeInput), screenSize);
}
